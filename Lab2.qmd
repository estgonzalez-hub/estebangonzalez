...
$R = V/I = (3.3-0.2) V / 8mA = 225$ A standard resistor value of 150 ohms was picked. 
...
![Schematic](images/seven_schematic.jpeg)
![Schematic](images/switch_schematic.jpeg){fig-cap="Figure 2. Schematic of the physical dual seven segment along with one of the switches for a digit circuit."}
...
![Schematic](images/keypad_schematic.jpeg){fig-cap="Figure 3. Schematic of the physical keypad circuit. As well as the corresponding coloumns and LEDs"}
