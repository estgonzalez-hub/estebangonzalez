...
![Block Diagram](images/block_diagram_lab1.jpg){fig-cap="Figure 1. Block diagram of Verilog design."}
...
![Schematic](images/schematic_lab1.jpg){fig-cap="Figure 2. Schematic of the physical circuit."}
...
![Figure 3. Waveform showing the top module being tested](images/top_testbench.png){fig-cap="Figure 3. Waveform showing the top module being tested"}


The screenshot above shows the QuestaSim simulation for the top module. 

![Figure 4. Waveform showing the seven segment display being tested](images/display.png){fig-cap="Figure 4. Waveform showing the seven segment display being tested"}


The screenshot above shows the QuestaSim simulation for the seven segment module. 

![Figure 5. Waveform showing the counter and led[2]](images/counter.png){fig-cap="Figure 5. Waveform showing the counter and led[2]"}
